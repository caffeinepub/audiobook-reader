...
export const idlService = IDL.Service({
  ...
  'getUserAllProgress' : IDL.Func([], [IDL.Vec(ReadingProgress)], ['query']),
  'getUserLibrary' : IDL.Func([], [IDL.Vec(BookMetadata)], ['query']),
  ...
  'saveReadingProgress' : IDL.Func([ReadingProgress], [], []),
});
