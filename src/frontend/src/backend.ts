...
import type { BookId as _BookId, BookMetadata as _BookMetadata, FileType as _FileType, ReadingProgress as _ReadingProgress, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBook(arg0: BookMetadata): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBook(to_candid_BookMetadata_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReadingProgress(arg0: BookId): Promise<ReadingProgress | null> {
        if (this.processError) {
            try {
    ...
    async getUserAllProgress(): Promise<Array<ReadingProgress>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAllProgress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserLibrary(): Promise<Array<BookMetadata>> {
        if (this.processError) {
            try {
    ...
    async saveReadingProgress(arg0: ReadingProgress): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveReadingProgress(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BookMetadata_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BookMetadata): BookMetadata {
...
function from_candid_opt_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ReadingProgress]): ReadingProgress | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pdf" in value ? FileType.pdf : "txt" in value ? FileType.txt : "epub" in value ? FileType.epub : value;
}
...
function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BookMetadata>): Array<BookMetadata> {
    return value.map((x)=>from_candid_BookMetadata_n15(_uploadFile, _downloadFile, x));
}
function to_candid_BookMetadata_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BookMetadata): _BookMetadata {
